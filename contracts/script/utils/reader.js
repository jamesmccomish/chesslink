...
// Path from contracts folder (where ffi script runs) to the folder containing the function code
const baseFunctionCodeFilePath = '../services/chainlink-functions/function-code/';
